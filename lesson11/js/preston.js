if (days[dayOfWeek] == "Friday"){
  document.getElementById("friday-banner").style.display = "block";
}

const apiCurrentURL = "https://api.openweathermap.org/data/2.5/weather?id=5604473&units=imperial&appid=3c8f0c832f40d0c980d88dc2c0b797af";
